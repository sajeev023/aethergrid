...
export function AboutPrincipal({ activeInst = "lfjc" }: AboutPrincipalProps) {
  ...
  return (
    <section id="principal" className="section-texture bg-white py-8 md:py-12 overflow-hidden">
      {/* Breadcrumb */}
      ...
      <div className="mx-auto max-w-5xl px-5 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr] gap-8 lg:gap-12 items-start">
          ...
          <Reveal className="text-center lg:text-left">
            <div className="relative mx-auto max-w-[240px] lg:max-w-[280px] lg:mx-0">
              ...
              <div className="relative border border-stone-texture bg-white p-1.5 shadow-lg z-10 rounded-sm">
                <div className="relative aspect-[4/5] w-full overflow-hidden rounded-sm">
                  <Image
                    ...
                    priority
                  />
                  <div className="absolute inset-0 border border-heritage-gold/25 m-2 rounded-sm pointer-events-none" />
                </div>
              </div>
              <div className="mt-4 text-center lg:text-left">
                <h2 className="font-serif text-xl font-bold text-academic-slate">{instData.principalName}</h2>
                <p className="text-[11px] font-bold uppercase tracking-widest text-heritage-gold-strong mt-1">
                  {instData.principalRole}
                </p>
                <p className="text-xs text-academic-slate/70 font-sans mt-1">
          ...
          <Reveal delay={0.1}>
            <div className="space-y-5">
              <div>
                ...
                <h2 className="font-serif text-2xl md:text-3xl font-semibold text-academic-slate leading-tight">
                  Nurturing Leaders, Serving Humanity
                </h2>
              </div>

              <div className="font-editorial text-base leading-relaxed text-academic-slate/90 italic space-y-4">
                <p>&ldquo;{instData.principalMessage}&rdquo;</p>
              </div>

              <div className="space-y-4 font-sans text-sm leading-6 text-academic-slate/75">
                <p>
              ...
              <div className="h-px w-16 bg-heritage-gold/50" />
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full overflow-hidden border border-heritage-gold/30 shrink-0">
                  <Image
                    src={instData.principalImg || "/images/brother_arun_official.jpg"}
                    alt={instData.principalName}
                    width={32}
                ...
                <div>
                  <p className="font-serif text-sm font-bold text-academic-slate">{instData.principalName}</p>
                  <p className="text-[10px] font-sans uppercase tracking-widest text-heritage-gold-strong">{instData.principalRole}</p>
                </div>
              </div>
            </div>
          </Reveal>
        ...
        {/* Bottom CTA */}
        <Reveal className="mt-10 border-t border-stone-texture/40 pt-8 flex flex-wrap justify-center gap-4">
          <Link
            href="/about"
