    ...
    <Section id="faculty" variant="default" className="bg-white border-b border-stone-texture/50">
      <div className="mx-auto max-w-3xl text-center mb-10">
        <Reveal>
          ...
          <p className="mt-4 text-sm leading-7 text-academic-slate/75 font-sans max-w-2xl mx-auto">
          ...
          <span className="gold-rule gold-rule-center mt-5" />
        </Reveal>
      </div>
        ...
        {SUB_PAGES.map((page, idx) => {
          ...
          return (
            <Reveal key={page.title} delay={idx * 0.07}>
              <Link
                href={page.href}
                className="group flex flex-col justify-between h-full bg-royal-cream/15 border border-stone-texture/60 rounded-xl p-6 hover:bg-white hover:border-heritage-gold/50 hover:shadow-panel-hover transition-all duration-300 relative overflow-hidden"
              >
                ...
                <div>
                  ...
                  <h3 className="font-serif text-xl font-bold text-academic-slate mb-2 group-hover:text-montfortian-blue transition-colors duration-300">
                    {page.title}
                  </h3>
                ...
                <div className="mt-5 pt-3 border-t border-stone-texture/40 flex items-center justify-between">
      ...
      <div className="border-t border-stone-texture/30 pt-12">
        <SectionHeading
