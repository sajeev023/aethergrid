        ...
        },
        {
          ...
          body: (
            <p>
              ...
              <Link href="/faculty" className="font-semibold text-montfortian-blue hover:underline">Faculty</Link>{" "}
        ...
        },
        {
          ...
          body: (
            <p>
              ...
              <Link href="/campus/campus-life" className="font-semibold text-montfortian-blue hover:underline">Campus &amp; Sports</Link>.
            </p>
          ),
        },
        {
