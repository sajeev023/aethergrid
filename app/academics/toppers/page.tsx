...
export default function ToppersPage() {
  return (
    <div className="bg-slate-50/60 pb-10 pt-4 sm:pb-16 sm:pt-6 md:pb-20 min-h-screen">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 md:px-8">
        ...
        {/* Hero Header */}
        <Reveal delay={0.05}>
          <div className="mt-2 sm:mt-4 border-b border-slate-200/80 pb-4 sm:pb-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-3 sm:gap-4">
              <div>
                <div className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full bg-amber-50 px-3 py-1 text-[11px] sm:text-xs font-bold text-amber-800 border border-amber-200/70 mb-2 sm:mb-3">
                  <Trophy className="h-3.5 w-3.5 text-amber-600" />
                  <span>Official Intermediate Board Examination Results (2026)</span>
                </div>
                <h1 className="font-serif text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-slate-900">
                  Intermediate Board Toppers
                </h1>
                <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm md:text-base text-slate-600 max-w-3xl font-sans leading-relaxed">
              ...
              <div className="flex items-center gap-2 bg-white px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl border border-slate-200/80 shadow-xs text-xs font-semibold text-slate-700 self-start sm:self-auto">
        ...
        <Reveal delay={0.05}>
          <div className="mt-8 sm:mt-16 p-3 sm:p-4 rounded-xl bg-white border border-slate-200/80 text-center max-w-3xl mx-auto shadow-xs">
