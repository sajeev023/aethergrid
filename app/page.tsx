  ...
  return (
    <>
      ...
      <div className="bg-white border-b border-stone-texture/40">
        <div className="mx-auto max-w-7xl px-5 md:px-8 py-4 flex flex-wrap items-center justify-center gap-2.5 md:gap-3.5">
          {QUICK_LINKS.map((item) => {
            ...
            return (
              <Reveal key={item.label}>
                <Link
                  href={item.href}
                  className="inline-flex items-center gap-2 rounded-full border border-stone-texture/70 bg-white px-5 py-2.5 text-[11px] font-bold uppercase tracking-[0.12em] text-academic-slate/80 hover:bg-montfortian-blue hover:text-white hover:border-montfortian-blue transition-all duration-300 font-sans shadow-sm hover:shadow-panel"
                >
      ...
      <Section variant="feature" className="bg-royal-cream/30 section-texture">
        ...
        <div className="mt-12 grid gap-5 lg:grid-cols-12">
          ...
          <Reveal className="lg:col-span-7">
            <Link
              href="/academics"
              className="group relative flex h-full flex-col justify-between overflow-hidden rounded-xl border border-stone-texture/60 bg-white p-6 md:p-8 shadow-panel hover:shadow-panel-hover hover:border-heritage-gold/40 transition-all duration-300"
            >
              ...
              <div className="flex items-center gap-2 text-[11px] font-bold text-heritage-gold-strong uppercase tracking-[0.16em] font-sans">
                <BookOpen className="h-4 w-4" aria-hidden="true" />
                <span>Academic Pathways</span>
              </div>
              <div className="mt-6">
                <h2 className="font-serif text-2xl md:text-3xl font-bold text-academic-slate leading-tight group-hover:text-montfortian-blue transition-colors duration-300">
                  Four Streams of Academic Excellence
                </h2>
                <p className="mt-3 text-sm leading-6 text-academic-slate/70 font-sans max-w-lg">
              ...
              <div className="mt-6 flex items-center gap-2 text-[12px] font-bold uppercase tracking-[0.14em] text-montfortian-blue font-sans">
                Explore Academics
          ...
          <div className="lg:col-span-5 grid gap-5">
            ...
            <Reveal delay={0.08}>
              <Link
                href="/admissions"
                className="group relative flex h-full flex-col justify-between overflow-hidden rounded-xl border border-heritage-gold/30 bg-royal-cream/40 p-6 hover:bg-royal-cream hover:border-heritage-gold/60 hover:shadow-panel-hover transition-all duration-300"
              >
                <div className="flex items-center gap-2 text-[11px] font-bold text-heritage-gold-strong uppercase tracking-[0.16em] font-sans">
                ...
                <div className="mt-4">
                  <h3 className="font-serif text-xl font-bold text-academic-slate leading-tight group-hover:text-montfortian-blue transition-colors duration-300">
                    Begin Your Journey Here
                  </h3>
                  <p className="mt-2 text-sm leading-6 text-academic-slate/65 font-sans">
                    A clear, transparent admissions pathway for families seeking academic excellence and disciplined character formation.
                  </p>
                </div>
                <div className="mt-4 flex items-center gap-2 text-[12px] font-bold uppercase tracking-[0.14em] text-montfortian-blue font-sans">
                  Start Inquiry
                  <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1.5" aria-hidden="true" />
                </div>
              </Link>
            ...
            <Reveal delay={0.14}>
              <Link
                href="/alumni"
                className="group relative flex h-full flex-col justify-between overflow-hidden rounded-xl border border-stone-texture/60 bg-white p-6 shadow-panel hover:shadow-panel-hover hover:border-heritage-gold/40 transition-all duration-300"
              >
                <div className="flex items-center gap-2 text-[11px] font-bold text-heritage-gold-strong uppercase tracking-[0.16em] font-sans">
            ...
            return (
              <Reveal key={program.slug} delay={index * 0.06}>
                <Link
                  ...
                  className="group relative flex h-full flex-col overflow-hidden rounded-xl border border-stone-texture/60 bg-white p-6 shadow-panel hover:shadow-panel-hover hover:border-heritage-gold/40 transition-all duration-300"
                >
                  <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-royal-cream text-montfortian-blue border border-stone-texture/60 group-hover:bg-montfortian-blue group-hover:text-white transition-colors duration-300">
                    <Icon className="h-5 w-5" aria-hidden="true" />
                  </div>
                  <h3 className="mt-4 font-serif text-lg font-bold text-academic-slate group-hover:text-montfortian-blue transition-colors duration-300">
                    {program.title}
                  </h3>
                  <p className="mt-1 text-[11px] font-bold uppercase tracking-[0.12em] text-heritage-gold-strong font-sans">
                    {program.subtitle}
                  </p>
                  <p className="mt-3 text-sm leading-6 text-academic-slate/70 font-sans flex-1">
                    {program.description}
                  </p>
                  <span className="mt-4 inline-flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-[0.14em] text-montfortian-blue font-sans">
                    Explore Stream
        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-14 lg:items-center">
          <Reveal className="lg:col-span-5">
            <div className="relative">
              <div className="relative aspect-[4/5] overflow-hidden rounded-lg border border-stone-texture/50 shadow-elevation">
                <Image
              ...
              <div className="absolute -bottom-5 -right-3 md:right-6 bg-montfortian-blue text-white p-5 md:p-6 shadow-float border border-heritage-gold/30 rounded-lg">
                <div className="font-serif text-3xl md:text-4xl font-bold leading-none">1974</div>
                <div className="mt-1 text-[10px] md:text-[11px] font-bold uppercase tracking-[0.16em] text-royal-cream/85 font-sans">
                  Montfortian Legacy
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7">
            <Reveal delay={0.1}>
              <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-heritage-gold-strong font-sans">
                Our Legacy
              </span>
              <h2 className="mt-3 font-serif text-3xl md:text-4xl lg:text-[2.75rem] font-bold text-academic-slate leading-tight tracking-tight">
                Five Decades of{" "}
              ...
              <div className="mt-7 space-y-5 text-sm md:text-base leading-7 text-academic-slate/75 font-sans">
                <p>
          ...
          {values.map((value, index) => {
            ...
            return (
              <Reveal key={value.title} delay={index * 0.06}>
                <div className="flex h-full flex-col rounded-xl border border-stone-texture/60 bg-white p-6 hover:border-heritage-gold/40 hover:shadow-panel transition-all duration-300">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-montfortian-blue/10 text-montfortian-blue border border-montfortian-blue/20">
                    <Icon className="h-5 w-5" aria-hidden="true" />
                  </div>
                  <h3 className="mt-4 font-serif text-base font-bold text-academic-slate">
                    {value.title}
                  </h3>
                  <p className="mt-2 text-sm leading-6 text-academic-slate/70 font-sans">
                    {value.description}
                  </p>
                </div>
              </Reveal>
      ...
      <Section variant="default" className="bg-royal-cream/20 border-y border-stone-texture/30">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          ...
          <Link
            href="/admissions"
            className="hidden md:inline-flex shrink-0 items-center gap-1.5 text-[11px] font-bold uppercase tracking-[0.14em] text-montfortian-blue hover:text-heritage-gold-strong transition-colors font-sans"
          >
            Admissions Updates
            ...
            return (
              <Reveal key={item.title} delay={idx * 0.06}>
                <article className="group h-full rounded-xl border border-stone-texture/50 bg-white p-5 shadow-panel hover:shadow-panel-hover hover:border-heritage-gold/40 transition-all duration-300 flex flex-col">
                  ...
                  <h3 className="mt-3 font-serif text-lg font-bold text-academic-slate leading-tight group-hover:text-montfortian-blue transition-colors duration-300">
                    {item.title}
                  </h3>
                  <p className="mt-2 text-sm leading-6 text-academic-slate/70 font-sans flex-1">
                    {item.body}
                  </p>
                  <div className="mt-4 pt-3 border-t border-stone-texture/30">
                    <Link
                      href={item.cta.href}
      ...
      <Section variant="feature" as="div" fullBleed className="!p-0 !py-0">
        <div className="relative overflow-hidden bg-deep-navy text-white">
          ...
          <div className="mx-auto max-w-7xl px-5 md:px-8 py-16 md:py-24 relative z-10">
            <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
              <Reveal className="lg:col-span-7">
                <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-heritage-gold-bright font-sans">
                  The LFJC Experience
                </span>
                <h2 className="mt-3 font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-[1.1] tracking-tight">
                  An Eight-Acre Living{" "}
                  <span className="text-heritage-gold italic font-editorial font-normal">
                    Heritage Campus
                  </span>
                </h2>
                <p className="mt-5 text-base leading-7 text-royal-cream/75 font-sans max-w-xl">
                  ...
                  {[
                    ...
                    return (
                      <Link
                        key={item.label}
                        href={item.href}
                        className="group relative overflow-hidden rounded-lg border border-white/10 bg-white/[0.04] p-5 md:p-6 hover:bg-white hover:text-deep-navy transition-all duration-300"
                      >
                        <Icon className="h-5 w-5 text-heritage-gold-bright group-hover:text-montfortian-blue transition-colors mb-4" aria-hidden="true" />
                        <span className="text-[12px] md:text-[13px] font-bold text-royal-cream/85 group-hover:text-deep-navy font-sans block leading-tight">
                          {item.label}
                        </span>
                        <ChevronRight className="absolute top-5 right-5 h-4 w-4 text-heritage-gold-bright/40 group-hover:text-montfortian-blue opacity-0 group-hover:opacity-100 transition-all" />
                      </Link>
                    );
                  })}
                </div>
      ...
      <Section variant="default" className="bg-white">
        <Reveal>
          <div className="relative overflow-hidden rounded-xl border border-heritage-gold/30 bg-gradient-to-br from-royal-cream via-white to-royal-cream/60 p-10 md:p-14 text-center shadow-panel">
            ...
            <Award className="h-9 w-9 text-heritage-gold mx-auto mb-5" />
            <h2 className="font-serif text-2xl md:text-3xl lg:text-4xl font-bold text-academic-slate leading-tight">
              Begin Your Admissions Inquiry
            </h2>
            <p className="mt-4 text-sm md:text-base leading-7 text-academic-slate/70 font-sans max-w-2xl mx-auto">
