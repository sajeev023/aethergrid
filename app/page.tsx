  ...
  return (
    <>
      ...
      <div className="bg-white border-b border-stone-texture/40">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-2.5 sm:py-3.5 flex flex-wrap items-center justify-center gap-2 sm:gap-2.5 md:gap-3.5">
          {QUICK_LINKS.map((item) => {
            ...
            return (
              <Reveal key={item.label}>
                <Link
                  href={item.href}
                  className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full border border-stone-texture/70 bg-white px-3.5 py-1.5 sm:px-5 sm:py-2.5 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] sm:tracking-[0.12em] text-academic-slate/80 hover:bg-montfortian-blue hover:text-white hover:border-montfortian-blue transition-all duration-300 font-sans shadow-xs hover:shadow-panel"
                >
        ...
        <div className="mt-6 sm:mt-10 lg:mt-12 grid gap-3.5 sm:gap-5 lg:grid-cols-12">
          ...
          <Reveal className="lg:col-span-7">
            ...
            >
              ...
              <div className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold text-heritage-gold-strong uppercase tracking-[0.16em] font-sans">
              ...
              <div className="mt-4 sm:mt-6 flex items-center gap-2 text-[11px] sm:text-[12px] font-bold uppercase tracking-[0.14em] text-montfortian-blue font-sans">
                Explore Academics
                <ArrowRight className="h-3.5 w-3.5 sm:h-4 sm:w-4 transition-transform group-hover:translate-x-1.5" aria-hidden="true" />
              </div>
            </Link>
          </Reveal>
          ...
          <div className="lg:col-span-5 grid gap-3.5 sm:gap-5">
            ...
            <Reveal delay={0.08}>
              ...
              >
                ...
                <div className="mt-3 sm:mt-4 flex items-center gap-2 text-[11px] sm:text-[12px] font-bold uppercase tracking-[0.14em] text-montfortian-blue font-sans">
                  Start Inquiry
                  <ArrowRight className="h-3.5 w-3.5 sm:h-4 sm:w-4 transition-transform group-hover:translate-x-1.5" aria-hidden="true" />
                </div>
              </Link>
            ...
            return (
              <Reveal key={program.slug} delay={index * 0.06}>
                ...
                >
                  ...
                  <p className="mt-0.5 sm:mt-1 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.12em] text-heritage-gold-strong font-sans">
                    {program.subtitle}
                  </p>
                  <p className="mt-2 sm:mt-3 text-xs sm:text-sm leading-relaxed sm:leading-6 text-academic-slate/70 font-sans flex-1">
                    {program.description}
                  </p>
                  <span className="mt-3 sm:mt-4 inline-flex items-center gap-1.5 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.14em] text-montfortian-blue font-sans">
                    Explore Stream
        ...
        <div className="grid gap-6 sm:gap-10 lg:grid-cols-12 lg:gap-14 lg:items-center">
          <Reveal className="lg:col-span-5">
            <div className="relative">
              <div className="relative aspect-[4/3] sm:aspect-[4/5] overflow-hidden rounded-lg border border-stone-texture/50 shadow-elevation">
                <Image
              ...
              <div className="absolute -bottom-3 sm:-bottom-5 -right-2 sm:-right-3 md:right-6 bg-montfortian-blue text-white p-3.5 sm:p-5 md:p-6 shadow-float border border-heritage-gold/30 rounded-lg">
                <div className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold leading-none">1974</div>
                <div className="mt-0.5 sm:mt-1 text-[9px] sm:text-[10px] md:text-[11px] font-bold uppercase tracking-[0.14em] sm:tracking-[0.16em] text-royal-cream/85 font-sans">
                  Montfortian Legacy
                </div>
              </div>
            </div>
          ...
          {NEWS.map((item, idx) => {
            ...
            return (
              <Reveal key={item.title} delay={idx * 0.06}>
                <article className="group h-full rounded-xl border border-stone-texture/50 bg-white p-4 sm:p-5 shadow-panel hover:shadow-panel-hover hover:border-heritage-gold/40 transition-all duration-300 flex flex-col">
                  <div className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold text-heritage-gold-strong uppercase tracking-[0.16em] font-sans">
        ...
        <div className="relative overflow-hidden bg-deep-navy text-white">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-10 sm:py-16 md:py-24 relative z-10">
            <div className="grid gap-6 sm:gap-12 lg:grid-cols-12 lg:items-center">
              <Reveal className="lg:col-span-7">
                <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.2em] text-heritage-gold-bright font-sans">
                  The LFJC Experience
                </span>
                ...
                <p className="mt-3 sm:mt-5 text-xs sm:text-base leading-relaxed sm:leading-7 text-royal-cream/75 font-sans max-w-xl">
                  ...
                  {[
                    ...
                    return (
                      <Link
                        key={item.label}
                        href={item.href}
                        className="group relative overflow-hidden rounded-lg border border-white/10 bg-white/[0.04] p-3.5 sm:p-5 md:p-6 hover:bg-white hover:text-deep-navy transition-all duration-300"
                      >
                        <Icon className="h-4 w-4 sm:h-5 sm:w-5 text-heritage-gold-bright group-hover:text-montfortian-blue transition-colors mb-2 sm:mb-4" aria-hidden="true" />
                        <span className="text-[11px] sm:text-[12px] md:text-[13px] font-bold text-royal-cream/85 group-hover:text-deep-navy font-sans block leading-tight">
                          {item.label}
                        </span>
                        <ChevronRight className="absolute top-3.5 right-3.5 sm:top-5 sm:right-5 h-3.5 w-3.5 sm:h-4 sm:w-4 text-heritage-gold-bright/40 group-hover:text-montfortian-blue opacity-0 group-hover:opacity-100 transition-all" />
                      </Link>
                    );
                  })}
                </div>
      ...
      <Section variant="default" className="bg-white">
        <Reveal>
          <div className="relative overflow-hidden rounded-xl border border-heritage-gold/30 bg-gradient-to-br from-royal-cream via-white to-royal-cream/60 p-5 sm:p-10 md:p-14 text-center shadow-panel">
            ...
            <Award className="h-7 w-7 sm:h-9 sm:w-9 text-heritage-gold mx-auto mb-3 sm:mb-5" />
            ...
            <p className="mt-2.5 sm:mt-4 text-xs sm:text-sm md:text-base leading-relaxed sm:leading-7 text-academic-slate/70 font-sans max-w-2xl mx-auto">
            ...
            <div className="mt-5 sm:mt-8 flex flex-col sm:flex-row gap-2.5 sm:gap-3 justify-center">
